...
public class RequestsFragment extends Fragment {
        ...
        FirebaseRecyclerAdapter<Contacts, RequestsViewHolder> adapter =
                new FirebaseRecyclerAdapter<Contacts, RequestsViewHolder>(options) {
                    ...
                    protected void onBindViewHolder(@NonNull final RequestsViewHolder holder, int position, @NonNull Contacts model) {
                        ...
                        holder.itemView.findViewById(R.id.request_cencel_btn).setVisibility(View.VISIBLE);
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                if(dataSnapshot.exists())
                                {
                                    ...
                                    if(type.equals("received"))
                                    {
                                        ...
                                        holder.itemView.findViewById(R.id.request_cencel_btn).setVisibility(View.INVISIBLE);
    ...
    public static class RequestsViewHolder extends RecyclerView.ViewHolder{
        ...
        public RequestsViewHolder(@NonNull View itemView) {
            ...
            CancelButton = itemView.findViewById(R.id.request_cencel_btn);
        }
